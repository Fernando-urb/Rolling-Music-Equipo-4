...
export default function AddToPlaylistModal({ visible, onClose, trackId }) {
  ...
  return (
    <>
      ...
      <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2  bg-gradient-to-br from-purple-900 via-blue-900 to-purple-500 p-6 rounded-lg shadow-lg z-50 w-80 max-h-[70vh] overflow-y-auto">
        <h2 className="text-lg font-bold mb-4 flex gap-2">
          {" "}
          <Plus />
          Agregar a Playlist
        </h2>
        {/* <p className="text-sm text-gray-100 mb-4">"{trackName}"</p> */}

        {/* Playlists existentes */}
        {playlistNames.length > 0 && (
          <div className="mb-4">
            <h3 className="text-sm font-semibold text-gray-150 mb-2">Playlists existentes:</h3>
        ...
        <div className="border-t pt-4">
          {!showNewPlaylist ? (
            <button
              className="w-full px-3 py-2 bg-gray-800 hover:bg-gray-700 text-blue-700 rounded-lg transition-colors flex gap-2"
              onClick={() => setShowNewPlaylist(true)}
            >
              <Plus /> Crear nueva playlist
            </button>
          ) : (
