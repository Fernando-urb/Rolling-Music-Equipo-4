          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
                En Sound-Music, creemos que la música es el lenguaje universal que une a las
                personas. Nuestra misión es democratizar el acceso a la música y crear una
                plataforma donde cada usuario pueda descubrir, compartir y disfrutar de experiencias
                musicales únicas.
              </p>
